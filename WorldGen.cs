...
namespace BabysFirstTextAdventure
{
    ...
    private List<WorldBlock> blocks;
        public World() {  //lot of things can be done with this doesn't matter right now, like a bunch of json or something, for now just a cs file to build the base world for some basic testing
    ...
    internal class WorldBlock
    {
        ...
        private List<GamePoi> gamePois;
        private List<GameBuilding> gameBuildings;
        private List<GameNpc> gameNpcs;
